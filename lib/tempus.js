...
class CachedByKeyResource {
    constructor(loader, options = {} ) {
        ...
        this.inFlight = {};
        this.cache = new LRU({max: max, maxAge: timeout * 1000});
    }
...
const allMaps = new CachedResource(() => fetchResponseByURL(`maps/detailedList`), { timeout: 600 });
...
const mapsByName = new CachedByKeyResource(name => fetchResponseByURL(`maps/name/${name}/fullOverview`));
const playersById = new CachedByKeyResource(id => fetchResponseByURL(`players/id/${id}/stats`));
...
const recordsById = new CachedByKeyResource(id => fetchResponseByURL(`records/id/${id}/overview`), { timeout: Infinity});
const demosById = new CachedByKeyResource(id => fetchResponseByURL(`demos/id/${id}/overview`), { timeout: Infinity});
